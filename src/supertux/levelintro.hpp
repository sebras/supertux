...
class LevelIntro : public Screen
{
 ...
 private:
  ...
  const Statistics* best_level_statistics; /**< Best level statistics of the
                                              level of which is the intro screen
                                              */
  ...
  Timer
      player_sprite_jump_timer; /**< When timer fires, the player sprite will
                                   "jump" */
  const PlayerStatus*
