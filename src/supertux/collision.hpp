...
class Constraints
{
 ...
 public:
  void
  constrain_left(float position, float velocity)
  {
  ...
  void
  constrain_right(float position, float velocity)
  {
  ...
  void
  constrain_top(float position, float velocity)
  {
  ...
  void
  constrain_bottom(float position, float velocity)
  {
  ...
  float
  get_position_left() const
  {
    return position_left;
  }
  float
  get_position_right() const
  {
    return position_right;
  }
  float
  get_position_top() const
  {
    return position_top;
  }
  float
  get_position_bottom() const
  {
