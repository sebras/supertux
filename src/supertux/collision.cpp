...
{
bool
intersects(const Rectf& r1, const Rectf& r2)
{
  if (r1.p2.x < r2.p1.x || r1.p1.x > r2.p2.x) return false;
  if (r1.p2.y < r2.p1.y || r1.p1.y > r2.p2.y) return false;
...
{
inline void
makePlane(const Vector& p1, const Vector& p2, Vector& n, float& c)
{
...
{
  if (!intersects(rect, (const Rectf&)triangle)) return false;
  ...
  switch (triangle.dir & AATriangle::DEFORM_MASK)
  {
    ...
    case AATriangle::DEFORM_BOTTOM:
      area.p1 = Vector(triangle.bbox.p1.x,
                       triangle.bbox.p1.y + triangle.bbox.get_height() / 2);
      area.p2 = triangle.bbox.p2;
      break;
    case AATriangle::DEFORM_TOP:
      area.p1 = triangle.bbox.p1;
      area.p2 = Vector(triangle.bbox.p2.x,
                       triangle.bbox.p1.y + triangle.bbox.get_height() / 2);
      break;
    case AATriangle::DEFORM_LEFT:
      area.p1 = triangle.bbox.p1;
      area.p2 = Vector(triangle.bbox.p1.x + triangle.bbox.get_width() / 2,
                       triangle.bbox.p2.y);
      break;
    case AATriangle::DEFORM_RIGHT:
      area.p1 = Vector(triangle.bbox.p1.x + triangle.bbox.get_width() / 2,
                       triangle.bbox.p1.y);
      area.p2 = triangle.bbox.p2;
      break;
    default:
  ...
  switch (triangle.dir & AATriangle::DIRECTION_MASK)
  {
    ...
    case AATriangle::SOUTHEAST:
      p1 = rect.p2;
      makePlane(Vector(area.p1.x, area.p2.y), Vector(area.p2.x, area.p1.y),
                normal, c);
      break;
    case AATriangle::NORTHWEST:
      p1 = rect.p1;
      makePlane(Vector(area.p2.x, area.p1.y), Vector(area.p1.x, area.p2.y),
                normal, c);
      break;
    default:
      assert(false);
...
void
set_rectangle_rectangle_constraints(Constraints* constraints, const Rectf& r1,
                                    const Rectf& r2,
                                    const Vector& addl_ground_movement)
{
...
bool
line_intersects_line(const Vector& line1_start, const Vector& line1_end,
...
bool
intersects_line(const Rectf& r, const Vector& line_start,
